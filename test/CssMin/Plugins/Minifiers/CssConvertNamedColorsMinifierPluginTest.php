...
use PHPMin\CssMin;
use PHPMin\CssMin\Plugins\Minifiers\CssConvertNamedColorsMinifierPlugin;

/**
 * Tests for CssConvertNamedColorsMinifierPlugin
 *
 ...
 * @version 1.0.1
 */
class CssConvertNamedColorsMinifierPluginTest extends TestCase
{
    ...
    {
        $inputFile = $this->dataDir . '/CssConvertNamedColorsMinifierPlugin-minify-in.css';
        $outputFile = $this->dataDir . '/CssConvertNamedColorsMinifierPlugin-minify-out.css';
