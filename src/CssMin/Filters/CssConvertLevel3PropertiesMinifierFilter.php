 ...
 * triggers on CSS Level 3 properties and will add declaration tokens
 ...
 * @version     1.0.1
 */
class CssConvertLevel3PropertiesMinifierFilter extends CssMinifierFilterAbstract
{
    /**
    ...
    protected $transformations = array(
        // Property                     Array(Mozilla, Webkit, Opera, Internet Explorer);
        // NULL values are placeholders and will get ignored
        ...
        "border-bottom-colors"          => array("-moz-border-bottom-colors", null, null, null),
        "border-bottom-left-radius"     => array("-moz-border-radius-bottomleft",
                                                 "-webkit-border-bottom-left-radius", null, null),
        "border-bottom-right-radius"    => array("-moz-border-radius-bottomright",
        ...
        "border-right-colors"           => array("-moz-border-right-colors", null, null, null),
        ...
        "border-start-style"            => array("-moz-border-start-style",
        ...
        "border-top-left-radius"        => array("-moz-border-radius-topleft",
                                                 "-webkit-border-top-left-radius", null, null),
        "border-top-right-radius"       => array("-moz-border-radius-topright",
        ...
        "box-lines"                     => array(null, "-webkit-box-lines", null, null),
        ...
        "font-smooth"                   => array(null, "-webkit-font-smoothing", null, null),
        ...
        "outline-radius-bottomleft"     => array("-moz-outline-radius-bottomleft", null, null, null),
        "outline-radius-bottomright"    => array("-moz-outline-radius-bottomright", null, null, null),
        "outline-radius-topleft"        => array("-moz-outline-radius-topleft", null, null, null),
        "outline-radius-topright"       => array("-moz-outline-radius-topright", null, null, null),
        ...
        "text-combine-upright"          => array("-moz-text-combine-upright", "-webkit-text-combine-upright",
                                                 null, null),
        "text-combine-horizontal"       => array("-moz-text-combine-horizontal", "-webkit-text-combine-horizontal",
                                                 "-ms-text-combine-horizontal", null),
        ...
        "transform-origin"              => array("-moz-transform-origin",
                                                 "-webkit-transform-origin", "-o-transform-origin", null),
        ...
        "transition-delay"              => array("-moz-transition-delay",
                                                 "-webkit-transition-delay", "-o-transition-delay", null),
        "transition-duration"           => array("-moz-transition-duration",
                                                 "-webkit-transition-duration", "-o-transition-duration", null),
        "transition-property"           => array("-moz-transition-property",
                                                 "-webkit-transition-property","-o-transition-property", null),
        "transition-timing-function"    => array("-moz-transition-timing-function",
                ...
                if (isset($transformations[$tProperty])) {
                    ...
                    if (is_callable($transformations[$tProperty])) {
                        ...
                        foreach ($transformations[$tProperty] as $property) {
                            ...
                            $t = new CssRulesetDeclarationToken($property, $tValue, $tmediaTypes);
