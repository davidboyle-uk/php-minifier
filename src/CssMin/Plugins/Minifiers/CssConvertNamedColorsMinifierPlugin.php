...
/**
 * This {@link CssMinifierPluginAbstract} will convert named color values to hexadecimal notation.
 *
 * Example:
 * <code>
 * color: black;
 ...
 * @version     1.0.1
 */
class CssConvertNamedColorsMinifierPlugin extends CssMinifierPluginAbstract
{
    /**
     ...
     * @var string
     */
    protected $reReplace = "\"\${1}\" . \$this->transformation[strtolower(\"\${2}\")] . \"\${3}\"";
