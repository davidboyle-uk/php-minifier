...
/**
 * {@link CssParserPluginAbstract Parser plugin} for parsing
 * @variables at-rule block with including declarations.
 *
 * Found @variables at-rule blocks will add a
 * {@link CssAtVariablesStartToken} and {@link CssAtVariablesEndToken} to the
 ...
 * @version     1.0.1
 */
class CssAtVariablesParserPlugin extends CssParserPluginAbstract
{
    /**
    ...
    public function parse($index, $char, $previousChar, $state)
    {
        ...
        elseif (($char === ";" || $char === "}")
            ...
            $this->parser->appendToken(
                new CssAtVariablesDeclarationToken($this->buffer, $value, $isImportant)
            );
            $this->buffer = "";
